...
namespace SASEvent {
  ...
  const int DIAMETER_TX_REQ = COMMON_BASE + 0x000007;
  const int DIAMETER_RX_REQ = COMMON_BASE + 0x000008;
  const int DIAMETER_TX_RSP = COMMON_BASE + 0x000009;
  const int DIAMETER_RX_RSP = COMMON_BASE + 0x00000A;
  const int DIAMETER_REQ_TIMEOUT = COMMON_BASE + 0x00000B;
