...
namespace SASEvent {
  ...
  const std::string CURRENT_RESOURCE_BUNDLE_DATESTAMP = "20151210";
  ...
  const int MEMCACHED_DELETE_FAILED_TO_REPLICA = COMMON_BASE + 0x00010C;
  const int MEMCACHED_DELETE_FAILED_TO_PROXY = COMMON_BASE + 0x00010D;
