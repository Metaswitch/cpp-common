/**
 * @file snmp_type_tagged_accumulator_table.cpp
 *
...
struct TypeTaggedStatisticsStatistics
{
  SNMP::ContinuousStatistics active_calls;
  SNMP::ContinuousStatistics active_registrations;
}
