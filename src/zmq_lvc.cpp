 ...
 * envelopes and externally are sent over a tcp:// publishing socket on port 666x.
 *
...
void LastValueCache::run()
{
  ...
  zmq_bind(_publisher, ("tcp://*:" + _zmq_port).c_str());
  ...
  zmq_unbind(_publisher, ("tcp://*:" + _zmq_port).c_str());
